<h1 class="mt-0 mb-4 font-bold">Add Sales</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="do_customer" id="do_customer" placeholder="Nomor DO" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="amount" id="amount" placeholder="Amount (kilogram, gram, etc)" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_sales" id="tgl_sales" placeholder="Nomor DO" class="form-control">
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#form_add_sales').submit(function(e) {
            e.preventDefault();
            const formData = new FormData(this);
            fetch('<?= SERVER_NAME ?>sales/add', {
                    method: 'POST',
                    body: formData
                })
                .then(res => res.json())
