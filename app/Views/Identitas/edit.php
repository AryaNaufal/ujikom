<h1 class="mt-0 mb-4 font-bold">Edit Identitas</h1>
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-content">
                ...
                <form id="form_edit_identitas" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label font-bold" for="namaIdentitas">Nama Identitas</label>
                                <input type="text" name="namaIdentitas" id="namaIdentitas" placeholder="Nama Identitas" class="form-control" required value="<?= $identitas['nama_identitas'] ?>">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span id="foto_name" class="font-bold"><?= basename($identitas['foto']); ?></span>
                                ...
                                <div class="my-2">
                                    <img src="<?= !empty($identitas['foto']) ? SERVER_NAME . "image/identitas/" . rawurlencode($identitas['foto']) : SERVER_NAME . "image/default.jpg" ?>" alt="" style="max-width: 150px;" id="foto_preview">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#form_edit_identitas').submit(function(e) {
            ...
            fetch('<?= SERVER_NAME ?>identitas/edit/<?= $identitas['id_identitas'] ?>', {
                    method: 'POST',
                    body: formData
                })
                .then(res => res.json())
